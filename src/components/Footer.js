        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">ImmoLux</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Achat & Vente</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Conseil Juridique</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Investissement</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Notre équipe</a></li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">+33 4 93 12 34 56</span>
              </div>
              <div className="flex items-center space-x-3">
                <EnvelopeIcon className="h-5 w-5 text-blue-400" />
                <span className="text-gray-400">contact@immolux.fr</span>
              </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 ImmoLux. Tous droits réservés.
            </p>
